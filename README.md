## 구현할 기능
- 랜덤한 숫자 3개를 pickNumberInRange()를 활용하여 생성한다.
- "숫자 야구 게임을 시작합니다."를 출력한다
- 사용자한테 숫자 3개를 입력받는다
- 같은 수가 같은 자리에 있으면 스트라이크, 다른 자리에 있으면 볼, 같은 수가 전혀 없으면 낫싱을 출력한다.
- 3개의 숫자를 모두 맞힐 경우 '3개의 숫자를 모두 맞히셨습니다! 게임 종료' 문구를 출력한다.
- 게임이 종료되면 '게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.' 문구를 출력한다.

## 예외 처리
사용자한테 숫자 3개를 입력받을 때
- 사용자의 입력이 숫자가 아닐 경우
- 사용자의 입력이 숫자지만 3자리를 입력하지 않았을 경우
- 사용자의 입력이 같은 숫자를 포함하였을 경우

게임을 재시작할 때
- 사용자의 입력이 1 이나 2가 아닌 경우

...
- 숫자 야구 게임 시작
- 3개의 서로 다른 숫자로 구성된 숫자를 생성
- 게임 루프 시작
  - 사용자에게 3자리 숫자를 입력하라는 메시지 출력 
  - 사용자 입력 받기 
  - 입력이 3자리가 아니면 "잘못된 입력값입니다." 에러 메시지 출력 후 4로 돌아감 
  - 입력한 숫자와 생성된 숫자를 비교하여 스트라이크와 볼 계산 
  - 게임 결과 출력 (스트라이크, 볼, 낫싱)
  - 만약 3스트라이크이면
    - "3개의 숫자를 모두 맞히셨습니다! 게임 종료" 메시지 출력 후 11로 이동 
  - 게임 종료 또는 새로운 게임 시작 여부 묻기 
  - 만약 새로운 게임 시작이면 2로 이동
- 게임 루프 종료
- 프로그램 종료

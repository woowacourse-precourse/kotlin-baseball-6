...
fun handleInput(userNumber: String, user: MutableList<String>) {
...
fun compareNum(computer: MutableList<String>, user: MutableList<String>) {
    for (i in 0 until SIZE) {
